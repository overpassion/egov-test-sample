...
<head>
    ...
    <script type="text/javaScript" language="javascript" defer="defer">
        ...
        function fn_egov_save2() {
        	frm = document.detailForm;
            frm.action = "<c:url value="${registerFlag == 'create' ? '/addSampleNew.do' : '/updateSample.do'}"/>";
            frm.submit();
        }
                ...
                <li>
                    <span class="btn_blue_l">
                        <a href="javascript:fn_egov_save2();">
                            <c:if test="${registerFlag == 'create'}"><spring:message code="button.create" />2</c:if>
                            <c:if test="${registerFlag == 'modify'}"><spring:message code="button.modify" />2</c:if>
                        </a>
                        <img src="<c:url value='/images/egovframework/example/btn_bg_r.gif'/>" style="margin-left:6px;" alt=""/>
                    </span>
                </li>
